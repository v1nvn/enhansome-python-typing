...
* [mypy](https://github.com/python/mypy) ⭐ 20,187 | 🐛 3,083 | 🌐 Python | 📅 2026-02-06 - Optional static typing (PEP 484).
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,203 | 🐛 204 | 🌐 Python | 📅 2026-02-07 - Fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
* [pytype](https://github.com/google/pytype) ⭐ 5,035 | 🐛 5 | 🌐 Python | 📅 2026-01-26 - Tool to check and infer types - without requiring type annotations.
* [basedpyright](https://github.com/detachhead/basedpyright) ⭐ 3,095 | 🐛 618 | 🌐 TypeScript | 📅 2026-02-04 - Pyright fork with improvements to VSCode support and various other fixes.
* [pylyzer](https://github.com/mtshiba/pylyzer/) ⭐ 2,874 | 🐛 29 | 🌐 Rust | 📅 2025-05-10 - A fast static code analyzer & language server for Python, written in Rust.
...
* [pydantic](https://github.com/samuelcolvin/pydantic) ⭐ 26,704 | 🐛 547 | 🌐 Python | 📅 2026-02-06 - Data parsing using Python type hinting. Supports dataclasses.
* [beartype](https://github.com/beartype/beartype) ⭐ 3,332 | 🐛 114 | 🌐 Python | 📅 2026-02-06 - Unbearably fast `O(1)` runtime type-checking in pure Python.
* [typeguard](https://github.com/agronholm/typeguard) ⭐ 1,744 | 🐛 32 | 🌐 Python | 📅 2026-02-06 - Another one runtime type checker.
...
* [strongtyping](https://github.com/FelixTheC/strongtyping) ⭐ 117 | 🐛 3 | 🌐 Python | 📅 2026-01-07 - Decorator which checks whether the function is called with the correct type of parameters.
* [trycast](https://github.com/davidfstr/trycast) ⭐ 86 | 🐛 5 | 🌐 Python | 📅 2025-12-10 - Parse JSON-like values whose shape is defined by typed dictionaries (TypedDicts) and other standard Python type hints.
* [typedpy](https://github.com/loyada/typedpy) ⭐ 17 | 🐛 3 | 🌐 Python | 📅 2024-09-24 - Type-safe, strict Python. Works well with standard Python.

## Stub packages

* [boto3-stubs](https://vemel.github.io/boto3_stubs_docs/) - Stubs for [boto3](https://github.com/boto/boto3) ⭐ 9,681 | 🐛 174 | 🌐 Python | 📅 2026-02-06.
* [typeshed](https://github.com/python/typeshed) ⭐ 4,998 | 🐛 352 | 🌐 Python | 📅 2026-02-07 - Collection of library stubs, with static types.
* [django-stubs](https://github.com/typeddjango/django-stubs) ⭐ 1,884 | 🐛 236 | 🌐 Python | 📅 2026-02-07 - Stubs for [Django](https://github.com/django/django) ⭐ 86,701 | 🐛 400 | 🌐 Python | 📅 2026-02-06.
* [asgiref](https://github.com/django/asgiref) ⭐ 1,613 | 🐛 65 | 🌐 Python | 📅 2026-02-03 - ASGI specification, provides [asgiref.typing](https://github.com/django/asgiref/blob/main/asgiref/typing.py) ⭐ 1,613 | 🐛 65 | 🌐 Python | 📅 2026-02-03 module with type annotations for ASGI servers.
* [torchtyping](https://github.com/patrick-kidger/torchtyping) ⭐ 1,473 | 🐛 16 | 🌐 Python | 📅 2025-05-02 - Enhanced type annotations for [PyTorch](https://pytorch.org/).
* [types-aiobotocore](https://vemel.github.io/types_aiobotocore_docs/) - Stubs for [aiobotocore](https://github.com/aio-libs/aiobotocore) ⭐ 1,383 | 🐛 15 | 🌐 Python | 📅 2026-02-05.
* [sqlalchemy-stubs](https://github.com/dropbox/sqlalchemy-stubs) ⭐ 583 | 🐛 87 | 🌐 Python | 📅 2024-06-10 - Stubs for [SQLAlchemy](https://github.com/sqlalchemy/sqlalchemy) ⭐ 11,471 | 🐛 208 | 🌐 Python | 📅 2026-02-06.
* [djangorestframework-stubs](https://github.com/typeddjango/djangorestframework-stubs) ⭐ 529 | 🐛 62 | 🌐 Python | 📅 2026-02-05 - Stubs for [DRF](https://github.com/encode/django-rest-framework) ⭐ 29,860 | 🐛 90 | 🌐 Python | 📅 2026-02-05.
* [celery-types](https://github.com/sbdchd/celery-types) ⭐ 138 | 🐛 7 | 🌐 Python | 📅 2026-01-12 - Type stubs for [Celery](https://github.com/celery/celery) ⭐ 27,977 | 🐛 764 | 🌐 Python | 📅 2026-02-04 and its related packages [django-celery-results](https://github.com/celery/django-celery-results) ⭐ 774 | 🐛 58 | 🌐 Python | 📅 2025-11-24, [ampq](https://github.com/celery/py-amqp) ⭐ 314 | 🐛 38 | 🌐 Python | 📅 2026-02-05, [kombu](https://github.com/celery/kombu) ⭐ 3,100 | 🐛 236 | 🌐 Python | 📅 2026-02-06, [billiard](https://github.com/celery/billiard) ⭐ 430 | 🐛 85 | 🌐 Python | 📅 2026-02-05, [vine](https://github.com/celery/vine) ⭐ 128 | 🐛 7 | 🌐 Python | 📅 2026-01-17 and [ephem](https://github.com/brandon-rhodes/pyephem) ⭐ 879 | 🐛 4 | 🌐 C | 📅 2025-07-01.
...
* [scipy-stubs](https://github.com/jorenham/scipy-stubs) ⭐ 82 | 🐛 20 | 🌐 Python | 📅 2026-02-06 - Stubs for [SciPy](https://github.com/scipy/scipy) ⭐ 14,429 | 🐛 1,756 | 🌐 Python | 📅 2026-02-07.
...
* [grpc-stubs](https://github.com/shabbyrobe/grpc-stubs) ⚠️ Archived - Stubs for [grpc](https://github.com/grpc/grpc) ⭐ 44,318 | 🐛 1,171 | 🌐 C++ | 📅 2026-02-07.
...
* [python-phonenumbers-stubs](https://github.com/AA-Turner/python-phonenumbers-stubs) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2021-09-01 - Stubs for [phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,707 | 🐛 12 | 🌐 Python | 📅 2026-01-30.
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,219 | 🐛 81 | 🌐 Python | 📅 2026-02-05 - Make your functions return something meaningful, typed, and safe.
* [phantom-types](https://github.com/antonagestam/phantom-types) ⭐ 233 | 🐛 18 | 🌐 Python | 📅 2026-01-01 - Phantom types.
* [useful-types](https://github.com/hauntsaninja/useful_types) ⭐ 149 | 🐛 14 | 🌐 Python | 📅 2026-01-05 - Collection of useful protocols and type aliases.
...
* [optype](https://github.com/jorenham/optype) ⭐ 74 | 🐛 12 | 🌐 Python | 📅 2026-02-03 - Opinionated `collections.abc` and `operators` alternative: Flexible single-method protocols and typed operators with predictable names.
...
* [typet](https://github.com/contains-io/typet) ⭐ 23 | 🐛 9 | 🌐 Python | 📅 2019-10-21 - Length-bounded types, dynamic object validation.

## Backports and improvements

* [typing-extensions](https://github.com/python/typing_extensions) ⭐ 548 | 🐛 28 | 🌐 Python | 📅 2026-01-28 - Backported and experimental type hints.
...
* [Ruff](https://github.com/astral-sh/ruff/) ⭐ 45,624 | 🐛 1,898 | 🌐 Rust | 📅 2026-02-07 - Extremely fast linter which supports lint rules from many other lint tools, such as flake8.
* [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,816 | 🐛 27 | 🌐 Python | 📅 2026-02-03 - The strictest and most opinionated Python linter ever.
...
* [flake8-annotations-complexity](https://github.com/best-doctor/flake8-annotations-complexity) ⭐ 51 | 🐛 3 | 🌐 Python | 📅 2025-03-04 - Plugin for flake8 to validate annotations complexity.
...
* [pytest-mypy-plugins](https://github.com/typeddjango/pytest-mypy-plugins) ⭐ 122 | 🐛 28 | 🌐 Python | 📅 2026-01-16 - Pytest plugin for testing mypy types, stubs, and plugins.
...
* [mypyc](https://github.com/python/mypy/tree/master/mypyc) ⭐ 20,187 | 🐛 3,083 | 🌐 Python | 📅 2026-02-06 - Compiles mypy-annotated, statically typed Python modules into CPython C extensions.
* [merge-pyi](https://github.com/google/pytype/tree/master/pytype/tools/merge_pyi) ⭐ 5,035 | 🐛 5 | 🌐 Python | 📅 2026-01-26 - Part of pytype toolchain, applies stub files onto source code.
* [mypy-protobuf](https://github.com/dropbox/mypy-protobuf) ⭐ 695 | 🐛 29 | 🌐 Python | 📅 2026-01-13 - Tool to generate mypy stubs from protobufs.
...
* [mypy-silent](https://github.com/whtsky/mypy-silent/) ⭐ 18 | 🐛 13 | 🌐 Python | 📅 2026-02-05 - Silence mypy by adding or removing code comments.
* [typing-json](https://pypi.org/project/typing-json/) - Lib for working with typed objects and JSON.

### Helper tools to add annotations to existing code

* [pyre infer](https://github.com/facebook/pyre-check) ⭐ 7,145 | 🐛 152 | 🌐 OCaml | 📅 2026-02-06 - Pyre has a powerful feature for migrating codebases to a typed format. The [infer](https://pyre-check.org/docs/pysa-coverage/) command-line option ingests a file or directory, makes educated guesses about the types used, and applies the annotations to the files.
* [pytype annotate-ast](https://github.com/google/pytype/tree/master/pytype/tools/annotate_ast) ⭐ 5,035 | 🐛 5 | 🌐 Python | 📅 2026-01-26 - A work-in-progress tool to annotate the nodes of an AST with their Python types.
* [monkeytype](https://github.com/instagram/MonkeyType) ⭐ 4,989 | 🐛 64 | 🌐 Python | 📅 2026-01-13 - Collects runtime types of function arguments and return values, and can automatically generate stub files or even add draft type annotations directly to your code based on the types collected at runtime.
...
* [RightTyper](https://github.com/RightTyper/RightTyper) ⭐ 352 | 🐛 3 | 🌐 Python | 📅 2026-02-06 - A tool that generates types for your function arguments and return values. RightTyper lets your code run at nearly full speed with almost no memory overhead.
...
* [pytest-annotate](https://github.com/kensho-technologies/pytest-annotate) ⭐ 112 | 🐛 0 | 🌐 Python | 📅 2022-06-07 - Pyannotate plugin for pytest.
* [no\_implicit\_optional](https://github.com/hauntsaninja/no_implicit_optional) ⭐ 104 | 🐛 2 | 🌐 Python | 📅 2023-11-25 - A codemod to make your implicit optional type hints [PEP 484](https://peps.python.org/pep-0484/#union-types) compliant.
* [infer-types](https://github.com/orsinium-labs/infer-types) ⭐ 97 | 🐛 0 | 🌐 Python | 📅 2023-03-17 - CLI tool to automatically infer and add type annotations into Python code.
...
* [jsonschema-gentypes](https://github.com/camptocamp/jsonschema-gentypes) ⭐ 48 | 🐛 19 | 🌐 Python | 📅 2026-02-07 - Generate Python types based on TypedDict from a JSON Schema.
...
* [mypy/plugins](https://github.com/python/mypy/tree/master/mypy/plugins) ⭐ 20,187 | 🐛 3,083 | 🌐 Python | 📅 2026-02-06 - Plugins already integrated into mypy.
...
* [loguru-mypy](https://github.com/kornicameister/loguru-mypy) ⭐ 22 | 🐛 16 | 🌐 Python | 📅 2024-05-01 - Plugin for [loguru](https://github.com/Delgan/loguru) ⭐ 23,569 | 🐛 250 | 🌐 Python | 📅 2026-01-15 support.
* [pynamodb-mypy](https://github.com/pynamodb/pynamodb-mypy) ⭐ 5 | 🐛 1 | 🌐 Python | 📅 2022-10-21 - Plugin for [PynamoDB](https://github.com/pynamodb/PynamoDB) ⭐ 2,646 | 🐛 317 | 🌐 Python | 📅 2026-01-06 support.
...
* [pylance](https://github.com/microsoft/pylance-release) ⭐ 1,985 | 🐛 421 | 🌐 Python | 📅 2026-02-06 - PyRight integration for VSCode.
* [nbQA](https://github.com/nbQA-dev/nbQA) ⭐ 1,188 | 🐛 19 | 🌐 Python | 📅 2026-02-03 - Run type checkers (e.g. Mypy) on Jupyter Notebooks.
...
* [mypy-playground](https://github.com/ymyzk/mypy-playground) ⭐ 76 | 🐛 44 | 🌐 Python | 📅 2026-02-07 - Online playground for mypy.
...
* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 281,773 | 🐛 15 | 🌐 Python | 📅 2026-02-02 - Curated list of awesome Python frameworks, libraries, software and resources.
