# Awesome Python Typing [![Awesome](https://awesome.re/badge-flat2.svg)](https://awesome.re) with stars
...
* [mypy](https://github.com/python/mypy) ⭐ 20,466 | 🐛 3,125 | 🌐 Python | 📅 2026-06-05 - Optional static typing (PEP 484).
* [ty](https://github.com/astral-sh/ty) ⭐ 18,864 | 🐛 785 | 🌐 Python | 📅 2026-06-06 - An extremely fast Python type checker, written in Rust, from the creators of Ruff and uv.
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,473 | 🐛 272 | 🌐 Python | 📅 2026-06-06 - Fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
* [pyrefly](https://github.com/facebook/pyrefly) ⭐ 6,609 | 🐛 623 | 🌐 Rust | 📅 2026-06-07 - A fast type checker and language server for Python.
* [pytype](https://github.com/google/pytype) ⭐ 5,037 | 🐛 5 | 🌐 Python | 📅 2026-03-16 - Tool to check and infer types - without requiring type annotations.
* [basedpyright](https://github.com/detachhead/basedpyright) ⭐ 3,393 | 🐛 646 | 🌐 TypeScript | 📅 2026-06-05 - Pyright fork with improvements to VSCode support and various other fixes.
* [pylyzer](https://github.com/mtshiba/pylyzer/) ⭐ 2,865 | 🐛 10 | 🌐 Rust | 📅 2025-05-10 - A fast static code analyzer & language server for Python, written in Rust.
* [zuban](https://github.com/zubanls/zuban) ⭐ 1,072 | 🐛 91 | 🌐 Rust | 📅 2026-06-06 - A Mypy-compatible Python type checker and Language Server built in Rust.
...
* [pycroscope](https://github.com/JelleZijlstra/pycroscope) ⭐ 41 | 🐛 1 | 🌐 Python | 📅 2026-06-03 - A semi-static type checker for Python code. It imports the modules it type checks, enabling `pycroscope` to understand many dynamic constructs that other type checkers will reject. This makes it possible to extend `pycroscope` with plugins that interact directly with your code.
* [PyCharm](https://www.jetbrains.com/pycharm/) - IDE for Professional Developers.

## Dynamic type checkers

* [pydantic](https://github.com/samuelcolvin/pydantic) ⭐ 27,959 | 🐛 565 | 🌐 Python | 📅 2026-06-05 - Data parsing using Python type hinting. Supports dataclasses.
* [beartype](https://github.com/beartype/beartype) ⭐ 3,430 | 🐛 119 | 🌐 Python | 📅 2026-06-06 - Unbearably fast `O(1)` runtime type-checking in pure Python.
* [typeguard](https://github.com/agronholm/typeguard) ⭐ 1,763 | 🐛 30 | 🌐 Python | 📅 2026-05-23 - Another one runtime type checker.
...
* [strongtyping](https://github.com/FelixTheC/strongtyping) ⭐ 119 | 🐛 3 | 🌐 Python | 📅 2026-05-13 - Decorator which checks whether the function is called with the correct type of parameters.
...
* [boto3-stubs](https://vemel.github.io/boto3_stubs_docs/) - Stubs for [boto3](https://github.com/boto/boto3) ⭐ 9,824 | 🐛 187 | 🌐 Python | 📅 2026-06-05.
* [typeshed](https://github.com/python/typeshed) ⭐ 5,071 | 🐛 363 | 🌐 Python | 📅 2026-06-06 - Collection of library stubs, with static types.
* [django-stubs](https://github.com/typeddjango/django-stubs) ⭐ 1,941 | 🐛 191 | 🌐 Python | 📅 2026-06-07 - Stubs for [Django](https://github.com/django/django) ⭐ 87,777 | 🐛 447 | 🌐 Python | 📅 2026-06-05.
* [asgiref](https://github.com/django/asgiref) ⭐ 1,620 | 🐛 73 | 🌐 Python | 📅 2026-05-20 - ASGI specification, provides [asgiref.typing](https://github.com/django/asgiref/blob/main/asgiref/typing.py) ⭐ 1,620 | 🐛 73 | 🌐 Python | 📅 2026-05-20 module with type annotations for ASGI servers.
* [torchtyping](https://github.com/patrick-kidger/torchtyping) ⭐ 1,481 | 🐛 16 | 🌐 Python | 📅 2025-05-02 - Enhanced type annotations for [PyTorch](https://pytorch.org/).
* [types-aiobotocore](https://vemel.github.io/types_aiobotocore_docs/) - Stubs for [aiobotocore](https://github.com/aio-libs/aiobotocore) ⭐ 1,411 | 🐛 21 | 🌐 Python | 📅 2026-06-06.
* [sqlalchemy-stubs](https://github.com/dropbox/sqlalchemy-stubs) ⭐ 585 | 🐛 87 | 🌐 Python | 📅 2024-06-10 - Stubs for [SQLAlchemy](https://github.com/sqlalchemy/sqlalchemy) ⭐ 11,894 | 🐛 212 | 🌐 Python | 📅 2026-06-05.
* [djangorestframework-stubs](https://github.com/typeddjango/djangorestframework-stubs) ⭐ 536 | 🐛 61 | 🌐 Python | 📅 2026-06-03 - Stubs for [DRF](https://github.com/encode/django-rest-framework) ⭐ 30,055 | 🐛 77 | 🌐 Python | 📅 2026-06-06.
* [celery-types](https://github.com/sbdchd/celery-types) ⭐ 147 | 🐛 11 | 🌐 Python | 📅 2026-03-12 - Type stubs for [Celery](https://github.com/celery/celery) ⭐ 28,565 | 🐛 785 | 🌐 Python | 📅 2026-06-03 and its related packages [django-celery-results](https://github.com/celery/django-celery-results) ⭐ 784 | 🐛 61 | 🌐 Python | 📅 2026-05-13, [ampq](https://github.com/celery/py-amqp) ⭐ 315 | 🐛 43 | 🌐 Python | 📅 2026-03-09, [kombu](https://github.com/celery/kombu) ⭐ 3,120 | 🐛 226 | 🌐 Python | 📅 2026-06-06, [billiard](https://github.com/celery/billiard) ⭐ 432 | 🐛 85 | 🌐 Python | 📅 2026-04-16, [vine](https://github.com/celery/vine) ⭐ 129 | 🐛 11 | 🌐 Python | 📅 2026-04-27 and [ephem](https://github.com/brandon-rhodes/pyephem) ⭐ 892 | 🐛 2 | 🌐 C | 📅 2026-04-30.
...
* [scipy-stubs](https://github.com/jorenham/scipy-stubs) ⭐ 91 | 🐛 25 | 🌐 Python | 📅 2026-06-06 - Stubs for [SciPy](https://github.com/scipy/scipy) ⭐ 14,738 | 🐛 1,794 | 🌐 Python | 📅 2026-06-06.
...
* [grpc-stubs](https://github.com/shabbyrobe/grpc-stubs) ⚠️ Archived - Stubs for [grpc](https://github.com/grpc/grpc) ⭐ 44,869 | 🐛 1,324 | 🌐 C++ | 📅 2026-06-06.
...
* [python-phonenumbers-stubs](https://github.com/AA-Turner/python-phonenumbers-stubs) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2021-09-01 - Stubs for [phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,747 | 🐛 12 | 🌐 Python | 📅 2026-06-05.
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,305 | 🐛 84 | 🌐 Python | 📅 2026-06-05 - Make your functions return something meaningful, typed, and safe.
...
* [optype](https://github.com/jorenham/optype) ⭐ 84 | 🐛 19 | 🌐 Python | 📅 2026-06-05 - Opinionated `collections.abc` and `operators` alternative: Flexible single-method protocols and typed operators with predictable names.
...
* [typing-extensions](https://github.com/python/typing_extensions) ⭐ 568 | 🐛 22 | 🌐 Python | 📅 2026-06-03 - Backported and experimental type hints.
...
* [Ruff](https://github.com/astral-sh/ruff/) ⭐ 47,848 | 🐛 2,006 | 🌐 Rust | 📅 2026-06-07 - Extremely fast linter which supports lint rules from many other lint tools, such as flake8.
* [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,854 | 🐛 26 | 🌐 Python | 📅 2026-06-05 - The strictest and most opinionated Python linter ever.
* [flake8-annotations](https://github.com/sco1/flake8-annotations) ⭐ 165 | 🐛 0 | 🌐 Python | 📅 2026-05-29 - Plugin for flake8 to check for presence of type annotations in function definitions.
...
* [flake8-pyi](https://github.com/ambv/flake8-pyi) ⭐ 82 | 🐛 21 | 🌐 Python | 📅 2026-05-11 - Plugin for Flake8 that provides specializations for type hinting stub files.
* [flake8-typing-imports](https://github.com/asottile/flake8-typing-imports) ⭐ 51 | 🐛 0 | 🌐 Python | 📅 2026-05-19 - Plugin which checks that typing imports are properly guarded.
...
* [pytest-mypy](https://github.com/dbader/pytest-mypy) ⭐ 257 | 🐛 9 | 🌐 Python | 📅 2025-04-02 - Mypy static type checker plugin for Pytest.
* [pytest-mypy-plugins](https://github.com/typeddjango/pytest-mypy-plugins) ⭐ 127 | 🐛 27 | 🌐 Python | 📅 2026-05-14 - Pytest plugin for testing mypy types, stubs, and plugins.
...
* [mypyc](https://github.com/python/mypy/tree/master/mypyc) ⭐ 20,466 | 🐛 3,125 | 🌐 Python | 📅 2026-06-05 - Compiles mypy-annotated, statically typed Python modules into CPython C extensions.
* [merge-pyi](https://github.com/google/pytype/tree/master/pytype/tools/merge_pyi) ⭐ 5,037 | 🐛 5 | 🌐 Python | 📅 2026-03-16 - Part of pytype toolchain, applies stub files onto source code.
* [mypy-protobuf](https://github.com/dropbox/mypy-protobuf) ⭐ 706 | 🐛 30 | 🌐 Python | 📅 2026-04-28 - Tool to generate mypy stubs from protobufs.
...
* [typesplainer](https://github.com/wasi-master/typesplainer) ⭐ 83 | 🐛 0 | 🌐 Python | 📅 2026-05-27 - A Python type explainer.
* [mypy-baseline](https://github.com/orsinium-labs/mypy-baseline) ⭐ 81 | 🐛 1 | 🌐 Python | 📅 2026-04-13 - Integrate mypy with existing codebase. A CLI tool that filters out existing type errors and reports only new ones.
...
* [mypy-silent](https://github.com/whtsky/mypy-silent/) ⭐ 19 | 🐛 13 | 🌐 Python | 📅 2026-06-03 - Silence mypy by adding or removing code comments.
* [typing-json](https://pypi.org/project/typing-json/) - Lib for working with typed objects and JSON.

### Helper tools to add annotations to existing code

* [pytype annotate-ast](https://github.com/google/pytype/tree/master/pytype/tools/annotate_ast) ⭐ 5,037 | 🐛 5 | 🌐 Python | 📅 2026-03-16 - A work-in-progress tool to annotate the nodes of an AST with their Python types.
* [monkeytype](https://github.com/instagram/MonkeyType) ⭐ 4,995 | 🐛 77 | 🌐 Python | 📅 2026-02-11 - Collects runtime types of function arguments and return values, and can automatically generate stub files or even add draft type annotations directly to your code based on the types collected at runtime.
* [pyannotate](https://github.com/dropbox/pyannotate) ⭐ 1,444 | 🐛 40 | 🌐 Python | 📅 2026-04-22 - Insert annotations into your source code based on call arguments and return types observed at runtime.
...
* [autotyping](https://github.com/JelleZijlstra/autotyping) ⭐ 284 | 🐛 8 | 🌐 Python | 📅 2025-09-19 - Automatically add simple return type annotations for functions (bool, None, Optional).
...
* [no\_implicit\_optional](https://github.com/hauntsaninja/no_implicit_optional) ⭐ 108 | 🐛 2 | 🌐 Python | 📅 2023-11-25 - A codemod to make your implicit optional type hints [PEP 484](https://peps.python.org/pep-0484/#union-types) compliant.
...
* [jsonschema-gentypes](https://github.com/camptocamp/jsonschema-gentypes) ⭐ 48 | 🐛 19 | 🌐 Python | 📅 2026-06-05 - Generate Python types based on TypedDict from a JSON Schema.
* [pytest-monkeytype](https://github.com/mariusvniekerk/pytest-monkeytype) ⭐ 46 | 🐛 2 | 🌐 Python | 📅 2020-07-29 - MonkeyType plugin for pytest.
* [auto-optional](https://github.com/Luttik/auto-optional) ⭐ 18 | 🐛 5 | 🌐 Python | 📅 2026-05-10 - Makes typed arguments Optional when the default argument is `None`.
* [PyTypes](https://github.com/pvs-hd-tea/PyTypes) ⭐ 11 | 🐛 9 | 🌐 Python | 📅 2022-08-29 - Infer Types by Python Tracing.

### Mypy plugins

* [mypy/plugins](https://github.com/python/mypy/tree/master/mypy/plugins) ⭐ 20,466 | 🐛 3,125 | 🌐 Python | 📅 2026-06-05 - Plugins already integrated into mypy.
* [mypy-zope](https://github.com/Shoobx/mypy-zope) ⭐ 40 | 🐛 19 | 🌐 Python | 📅 2026-05-18 - Plugin for [zope.interface](https://zopeinterface.readthedocs.io/en/latest/) support.
...
* [loguru-mypy](https://github.com/kornicameister/loguru-mypy) ⭐ 22 | 🐛 16 | 🌐 Python | 📅 2024-05-01 - Plugin for [loguru](https://github.com/Delgan/loguru) ⭐ 23,944 | 🐛 251 | 🌐 Python | 📅 2026-05-24 support.
* [pynamodb-mypy](https://github.com/pynamodb/pynamodb-mypy) ⭐ 5 | 🐛 1 | 🌐 Python | 📅 2022-10-21 - Plugin for [PynamoDB](https://github.com/pynamodb/PynamoDB) ⭐ 2,649 | 🐛 317 | 🌐 Python | 📅 2026-05-29 support.
...
* [pylance](https://github.com/microsoft/pylance-release) ⭐ 2,084 | 🐛 275 | 🌐 Python | 📅 2026-06-04 - PyRight integration for VSCode.
* [nbQA](https://github.com/nbQA-dev/nbQA) ⭐ 1,199 | 🐛 21 | 🌐 Python | 📅 2026-05-25 - Run type checkers (e.g. Mypy) on Jupyter Notebooks.
...
* [mypy-playground](https://github.com/ymyzk/mypy-playground) ⭐ 77 | 🐛 45 | 🌐 Python | 📅 2026-06-05 - Online playground for mypy.
...
* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 301,688 | 🐛 22 | 🌐 Python | 📅 2026-06-06 - Curated list of awesome Python frameworks, libraries, software and resources.
