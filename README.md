...
* [mypy](https://github.com/python/mypy) ⭐ 20,386 | 🐛 3,127 | 🌐 Python | 📅 2026-04-22 - Optional static typing (PEP 484).
* [ty](https://github.com/astral-sh/ty) ⭐ 18,393 | 🐛 771 | 🌐 Python | 📅 2026-04-22 - An extremely fast Python type checker, written in Rust, from the creators of Ruff and uv.
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,385 | 🐛 260 | 🌐 Python | 📅 2026-04-21 - Fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
* [pytype](https://github.com/google/pytype) ⭐ 5,031 | 🐛 6 | 🌐 Python | 📅 2026-03-16 - Tool to check and infer types - without requiring type annotations.
* [basedpyright](https://github.com/detachhead/basedpyright) ⭐ 3,281 | 🐛 633 | 🌐 TypeScript | 📅 2026-04-20 - Pyright fork with improvements to VSCode support and various other fixes.
* [pylyzer](https://github.com/mtshiba/pylyzer/) ⭐ 2,868 | 🐛 15 | 🌐 Rust | 📅 2025-05-10 - A fast static code analyzer & language server for Python, written in Rust.
* [pyanalyze](https://github.com/quora/pyanalyze) ⭐ 381 | 🐛 61 | 🌐 Python | 📅 2026-01-27 - Extensible static analyzer and type checker.
...
* [pydantic](https://github.com/samuelcolvin/pydantic) ⭐ 27,557 | 🐛 558 | 🌐 Python | 📅 2026-04-21 - Data parsing using Python type hinting. Supports dataclasses.
* [beartype](https://github.com/beartype/beartype) ⭐ 3,401 | 🐛 106 | 🌐 Python | 📅 2026-04-21 - Unbearably fast `O(1)` runtime type-checking in pure Python.
* [typeguard](https://github.com/agronholm/typeguard) ⭐ 1,754 | 🐛 29 | 🌐 Python | 📅 2026-04-06 - Another one runtime type checker.
...
* [strongtyping](https://github.com/FelixTheC/strongtyping) ⭐ 119 | 🐛 3 | 🌐 Python | 📅 2026-04-19 - Decorator which checks whether the function is called with the correct type of parameters.
...
* [boto3-stubs](https://vemel.github.io/boto3_stubs_docs/) - Stubs for [boto3](https://github.com/boto/boto3) ⭐ 9,771 | 🐛 192 | 🌐 Python | 📅 2026-04-22.
* [typeshed](https://github.com/python/typeshed) ⭐ 5,048 | 🐛 351 | 🌐 Python | 📅 2026-04-22 - Collection of library stubs, with static types.
* [django-stubs](https://github.com/typeddjango/django-stubs) ⭐ 1,923 | 🐛 197 | 🌐 Python | 📅 2026-04-21 - Stubs for [Django](https://github.com/django/django) ⭐ 87,303 | 🐛 433 | 🌐 Python | 📅 2026-04-20.
* [asgiref](https://github.com/django/asgiref) ⭐ 1,617 | 🐛 73 | 🌐 Python | 📅 2026-02-23 - ASGI specification, provides [asgiref.typing](https://github.com/django/asgiref/blob/main/asgiref/typing.py) ⭐ 1,617 | 🐛 73 | 🌐 Python | 📅 2026-02-23 module with type annotations for ASGI servers.
* [torchtyping](https://github.com/patrick-kidger/torchtyping) ⭐ 1,478 | 🐛 16 | 🌐 Python | 📅 2025-05-02 - Enhanced type annotations for [PyTorch](https://pytorch.org/).
* [types-aiobotocore](https://vemel.github.io/types_aiobotocore_docs/) - Stubs for [aiobotocore](https://github.com/aio-libs/aiobotocore) ⭐ 1,403 | 🐛 24 | 🌐 Python | 📅 2026-04-21.
* [sqlalchemy-stubs](https://github.com/dropbox/sqlalchemy-stubs) ⭐ 585 | 🐛 87 | 🌐 Python | 📅 2024-06-10 - Stubs for [SQLAlchemy](https://github.com/sqlalchemy/sqlalchemy) ⭐ 11,779 | 🐛 218 | 🌐 Python | 📅 2026-04-21.
* [djangorestframework-stubs](https://github.com/typeddjango/djangorestframework-stubs) ⭐ 536 | 🐛 62 | 🌐 Python | 📅 2026-04-21 - Stubs for [DRF](https://github.com/encode/django-rest-framework) ⭐ 29,984 | 🐛 78 | 🌐 Python | 📅 2026-04-07.
* [celery-types](https://github.com/sbdchd/celery-types) ⭐ 145 | 🐛 11 | 🌐 Python | 📅 2026-03-12 - Type stubs for [Celery](https://github.com/celery/celery) ⭐ 28,395 | 🐛 782 | 🌐 Python | 📅 2026-04-20 and its related packages [django-celery-results](https://github.com/celery/django-celery-results) ⭐ 783 | 🐛 59 | 🌐 Python | 📅 2026-03-25, [ampq](https://github.com/celery/py-amqp) ⭐ 315 | 🐛 43 | 🌐 Python | 📅 2026-03-09, [kombu](https://github.com/celery/kombu) ⭐ 3,110 | 🐛 223 | 🌐 Python | 📅 2026-04-22, [billiard](https://github.com/celery/billiard) ⭐ 431 | 🐛 85 | 🌐 Python | 📅 2026-04-16, [vine](https://github.com/celery/vine) ⭐ 129 | 🐛 7 | 🌐 Python | 📅 2026-03-04 and [ephem](https://github.com/brandon-rhodes/pyephem) ⭐ 888 | 🐛 3 | 🌐 C | 📅 2026-02-28.
...
* [scipy-stubs](https://github.com/jorenham/scipy-stubs) ⭐ 87 | 🐛 23 | 🌐 Python | 📅 2026-04-21 - Stubs for [SciPy](https://github.com/scipy/scipy) ⭐ 14,623 | 🐛 1,783 | 🌐 Python | 📅 2026-04-21.
...
* [grpc-stubs](https://github.com/shabbyrobe/grpc-stubs) ⚠️ Archived - Stubs for [grpc](https://github.com/grpc/grpc) ⭐ 44,655 | 🐛 1,292 | 🌐 C++ | 📅 2026-04-21.
...
* [python-phonenumbers-stubs](https://github.com/AA-Turner/python-phonenumbers-stubs) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2021-09-01 - Stubs for [phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) ⭐ 3,731 | 🐛 12 | 🌐 Python | 📅 2026-04-13.
...
* [returns](https://github.com/dry-python/returns) ⭐ 4,266 | 🐛 82 | 🌐 Python | 📅 2026-04-20 - Make your functions return something meaningful, typed, and safe.
* [phantom-types](https://github.com/antonagestam/phantom-types) ⭐ 236 | 🐛 18 | 🌐 Python | 📅 2026-01-01 - Phantom types.
...
* [option](https://github.com/MaT1g3R/option) ⭐ 102 | 🐛 8 | 🌐 Python | 📅 2024-01-01 - Rust like Option and Result types.
* [meiga](https://github.com/alice-biometrics/meiga) ⭐ 82 | 🐛 1 | 🌐 Python | 📅 2024-10-22 - Simple, typed and monad-based Result type.
* [optype](https://github.com/jorenham/optype) ⭐ 82 | 🐛 13 | 🌐 Python | 📅 2026-04-16 - Opinionated `collections.abc` and `operators` alternative: Flexible single-method protocols and typed operators with predictable names.
...
* [typing-extensions](https://github.com/python/typing_extensions) ⭐ 561 | 🐛 28 | 🌐 Python | 📅 2026-04-06 - Backported and experimental type hints.
...
* [Ruff](https://github.com/astral-sh/ruff/) ⭐ 47,196 | 🐛 1,962 | 🌐 Rust | 📅 2026-04-22 - Extremely fast linter which supports lint rules from many other lint tools, such as flake8.
* [wemake-python-styleguide](https://github.com/wemake-services/wemake-python-styleguide) ⭐ 2,839 | 🐛 25 | 🌐 Python | 📅 2026-04-20 - The strictest and most opinionated Python linter ever.
* [flake8-annotations](https://github.com/sco1/flake8-annotations) ⭐ 164 | 🐛 0 | 🌐 Python | 📅 2026-04-17 - Plugin for flake8 to check for presence of type annotations in function definitions.
...
* [flake8-pyi](https://github.com/ambv/flake8-pyi) ⭐ 81 | 🐛 19 | 🌐 Python | 📅 2026-04-16 - Plugin for Flake8 that provides specializations for type hinting stub files.
* [flake8-typing-imports](https://github.com/asottile/flake8-typing-imports) ⭐ 51 | 🐛 0 | 🌐 Python | 📅 2026-04-14 - Plugin which checks that typing imports are properly guarded.
...
* [pytest-mypy-plugins](https://github.com/typeddjango/pytest-mypy-plugins) ⭐ 125 | 🐛 28 | 🌐 Python | 📅 2026-04-22 - Pytest plugin for testing mypy types, stubs, and plugins.
...
* [mypyc](https://github.com/python/mypy/tree/master/mypyc) ⭐ 20,386 | 🐛 3,127 | 🌐 Python | 📅 2026-04-22 - Compiles mypy-annotated, statically typed Python modules into CPython C extensions.
* [merge-pyi](https://github.com/google/pytype/tree/master/pytype/tools/merge_pyi) ⭐ 5,031 | 🐛 6 | 🌐 Python | 📅 2026-03-16 - Part of pytype toolchain, applies stub files onto source code.
* [mypy-protobuf](https://github.com/dropbox/mypy-protobuf) ⭐ 703 | 🐛 32 | 🌐 Python | 📅 2026-04-16 - Tool to generate mypy stubs from protobufs.
...
* [mypy-baseline](https://github.com/orsinium-labs/mypy-baseline) ⭐ 77 | 🐛 1 | 🌐 Python | 📅 2026-04-13 - Integrate mypy with existing codebase. A CLI tool that filters out existing type errors and reports only new ones.
...
* [mypy-silent](https://github.com/whtsky/mypy-silent/) ⭐ 19 | 🐛 13 | 🌐 Python | 📅 2026-04-09 - Silence mypy by adding or removing code comments.
* [typing-json](https://pypi.org/project/typing-json/) - Lib for working with typed objects and JSON.

### Helper tools to add annotations to existing code

* [pyre infer](https://github.com/facebook/pyre-check) ⭐ 7,150 | 🐛 162 | 🌐 OCaml | 📅 2026-04-20 - Pyre has a powerful feature for migrating codebases to a typed format. The [infer](https://pyre-check.org/docs/pysa-coverage/) command-line option ingests a file or directory, makes educated guesses about the types used, and applies the annotations to the files.
* [pytype annotate-ast](https://github.com/google/pytype/tree/master/pytype/tools/annotate_ast) ⭐ 5,031 | 🐛 6 | 🌐 Python | 📅 2026-03-16 - A work-in-progress tool to annotate the nodes of an AST with their Python types.
* [monkeytype](https://github.com/instagram/MonkeyType) ⭐ 5,001 | 🐛 75 | 🌐 Python | 📅 2026-02-11 - Collects runtime types of function arguments and return values, and can automatically generate stub files or even add draft type annotations directly to your code based on the types collected at runtime.
* [pyannotate](https://github.com/dropbox/pyannotate) ⭐ 1,447 | 🐛 40 | 🌐 Python | 📅 2026-04-22 - Insert annotations into your source code based on call arguments and return types observed at runtime.
* [RightTyper](https://github.com/RightTyper/RightTyper) ⭐ 355 | 🐛 0 | 🌐 Python | 📅 2026-04-14 - A tool that generates types for your function arguments and return values. RightTyper lets your code run at nearly full speed with almost no memory overhead.
...
* [typilus](https://github.com/typilus/typilus) ⭐ 62 | 🐛 6 | 🌐 Python | 📅 2023-02-08 - A deep learning algorithm for predicting types in Python. Also available as a [GitHub action](https://github.com/typilus/typilus-action) ⭐ 43 | 🐛 12 | 🌐 Python | 📅 2023-03-23
* [jsonschema-gentypes](https://github.com/camptocamp/jsonschema-gentypes) ⭐ 48 | 🐛 19 | 🌐 Python | 📅 2026-04-16 - Generate Python types based on TypedDict from a JSON Schema.
...
* [mypy/plugins](https://github.com/python/mypy/tree/master/mypy/plugins) ⭐ 20,386 | 🐛 3,127 | 🌐 Python | 📅 2026-04-22 - Plugins already integrated into mypy.
* [mypy-zope](https://github.com/Shoobx/mypy-zope) ⭐ 40 | 🐛 21 | 🌐 Python | 📅 2026-04-20 - Plugin for [zope.interface](https://zopeinterface.readthedocs.io/en/latest/) support.
...
* [loguru-mypy](https://github.com/kornicameister/loguru-mypy) ⭐ 22 | 🐛 16 | 🌐 Python | 📅 2024-05-01 - Plugin for [loguru](https://github.com/Delgan/loguru) ⭐ 23,825 | 🐛 249 | 🌐 Python | 📅 2026-04-06 support.
* [pynamodb-mypy](https://github.com/pynamodb/pynamodb-mypy) ⭐ 5 | 🐛 1 | 🌐 Python | 📅 2022-10-21 - Plugin for [PynamoDB](https://github.com/pynamodb/PynamoDB) ⭐ 2,649 | 🐛 317 | 🌐 Python | 📅 2026-01-06 support.
...
* [pylance](https://github.com/microsoft/pylance-release) ⭐ 2,059 | 🐛 350 | 🌐 Python | 📅 2026-04-21 - PyRight integration for VSCode.
* [nbQA](https://github.com/nbQA-dev/nbQA) ⭐ 1,196 | 🐛 19 | 🌐 Python | 📅 2026-04-14 - Run type checkers (e.g. Mypy) on Jupyter Notebooks.
...
* [mypy-playground](https://github.com/ymyzk/mypy-playground) ⭐ 77 | 🐛 47 | 🌐 Python | 📅 2026-04-22 - Online playground for mypy.
...
* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 293,710 | 🐛 19 | 🌐 Python | 📅 2026-04-21 - Curated list of awesome Python frameworks, libraries, software and resources.
